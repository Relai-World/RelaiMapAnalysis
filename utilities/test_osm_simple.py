...
if not result:
    print(f"ERROR: Location '{TEST_LOCATION}' not found in database!")
    exit(1)
...
print("\n" + "=" * 80)
print("SUCCESS! Amenity extraction from OpenStreetMap works!")
print("=" * 80)
print("\nThis data comes from the SAME map you're viewing.")
print("To extract for all 7 locations, run: python extract_osm_amenities.py")
