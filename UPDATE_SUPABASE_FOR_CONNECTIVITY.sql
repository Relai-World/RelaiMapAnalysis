-- =====================================================
-- UPDATE SUPABASE FUNCTION TO INCLUDE COORDINATES
-- Run this in Supabase SQL Editor
-- =====================================================

-- This updates the get_properties_func to return latitude and longitude
-- which are needed for the connectivity feature
